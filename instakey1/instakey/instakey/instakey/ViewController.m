...
- (void)viewDidAppear:(BOOL)animated {
    ...
    appDelegate.instagram.accessToken = [[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] objectForKey:@"accessToken"];
...
-(void)igDidLogin {
    ...
    AppDelegate* appDelegate = (AppDelegate*)[UIApplication sharedApplication].delegate;
    [[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] setObject:appDelegate.instagram.accessToken forKey:@"accessToken"];
    [[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] synchronize];
    NSLog(@"suite: %@",[[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] objectForKey:@"accessToken"]);
    [_loginButton setTitle:@"Logged in" forState:UIControlStateNormal];
    [self didLogin];
...
-(void)igDidLogout {
    ...
    [[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] setObject:nil forKey:@"accessToken"];
    [[[NSUserDefaults alloc] initWithSuiteName:@"group.com.jackrogers.instakey"] synchronize];
}
